    ...
    <div className={isOpen ? "slid" : "sidebar_head"} >
      ...
      <div className="d-flex">
        ...
        { isOpen &&   <div className="closebuttom" onClick={() => setIsOpen(!isOpen)}>
          <Image width={100} height={30} className={classes.icon} src="/icon1.png" alt="icon"></Image>
          </div>}
      </div>
      <div className={classes.Sidebarlist}>
          ...
          <div className={classes.sidebardropdown}> 
            ...
            <ul className={dpopen  ? classes.dropsidedrop :""}>
              ...
              <li> <Link href="/calender" className={router.pathname == "/" ? "active" : ""}> <span></span><span>{'Schedule'}</span></Link></li>
